# Fleet Bootstrap Specification

## Purpose
Defines how a repository joining the fleet receives the files every fleet repository must carry identically, and what it is told about the required files it still has to write.
