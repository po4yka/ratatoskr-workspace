...
- [x] 1.3 `ratatoskr-chatgpt` and `ratatoskr-claude` — add failing terminal-report tests and emit
  ...
  `d82fe59` and `4296447` are locally gated and awaiting ordered main integration.)*
...
- [ ] 2.2 After child changes merge, pin the verified commits and run the available workspace
  integration checks. Verification: workspace main records the compatible snapshot. *(Awaiting
  ordered main integration and hosted checks.)*
